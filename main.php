    ...
    <div class="social_links_widget_op">
        <ul>
            ...
            foreach($ordarr as $id=>$val): ?>
            	<li class="social_links_widget"> <a class="<?php echo $id; ?>" href="<?php echo $social_data_option[sosurl][$id]; ?>"><?php echo $id; ?></a> </li>				
			<?php endforeach;
			}
...
function social_links_widget_admin_menu() { 
    add_menu_page(
		...
		plugins_url( 'social-links-widget/img/social-icon.png') , 50
	); 
}
